...
#include "caffe/layers/softmax_infogain_loss_layer.hpp"
...
namespace caffe {
  ...
  void SoftmaxWithInfogainLossLayer<Dtype>::LayerSetUp(
  ...
  template <typename Dtype>
  void SoftmaxWithInfogainLossLayer<Dtype>::Reshape(
					 const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
  ...
  template <typename Dtype>
  Dtype SoftmaxWithInfogainLossLayer<Dtype>::get_normalizer(
  ...
  template <typename Dtype>
  void SoftmaxWithInfogainLossLayer<Dtype>::sum_rows_of_H(const Blob<Dtype>* H) {
  ...
  template <typename Dtype>
  void SoftmaxWithInfogainLossLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
  ...
  template <typename Dtype>
  void SoftmaxWithInfogainLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
  ...
  INSTANTIATE_CLASS(SoftmaxWithInfogainLossLayer);
  REGISTER_LAYER_CLASS(SoftmaxWithInfogainLoss);
}  // namespace caffe
